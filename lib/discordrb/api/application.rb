...
module Discordrb::API::Application
  ...
  def create_global_command(token, application_id, name, description, options = [], default_permission = nil, type = 1, default_member_permissions = nil, contexts = nil, integration_types = nil, name_localizations = {}, description_localizations = {})
    Discordrb::API.request(
      :applications_aid_commands,
      nil,
      :post,
      "#{Discordrb::API.api_base}/applications/#{application_id}/commands",
      { name: name, description: description, options: options, default_permission: default_permission, type: type, default_member_permissions: default_member_permissions, contexts: contexts, integration_types: integration_types, name_localizations: name_localizations, description_localizations: description_localizations }.to_json,
      Authorization: token,
      content_type: :json
    )
  end
  ...
  def edit_global_command(token, application_id, command_id, name = nil, description = nil, options = nil, default_permission = nil, type = 1, default_member_permissions = nil, contexts = nil, name_localizations = {}, description_localizations = {})
    Discordrb::API.request(
      :applications_aid_commands_cid,
      nil,
      :patch,
  ...
  def create_guild_command(token, application_id, guild_id, name, description, options = nil, default_permission = nil, type = 1, default_member_permissions = nil, contexts = nil, name_localizations = {}, description_localizations = {})
    Discordrb::API.request(
      :applications_aid_guilds_gid_commands,
      guild_id,
      :post,
  ...
  def edit_guild_command(token, application_id, guild_id, command_id, name = nil, description = nil, options = nil, default_permission = nil, type = 1, default_member_permissions = nil, contexts = nil, name_localizations = {}, description_localizations = {})
    Discordrb::API.request(
      :applications_aid_guilds_gid_commands_cid,
      guild_id,
      :patch,
