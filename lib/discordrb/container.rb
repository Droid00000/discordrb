...
module Discordrb
  ...
  module EventContainer
    ...
    # @option attributes [Color, Integer] :colour A role colour to match against.
    ...
    # @param string [String] The name of the class.
    # @return [Class] The class.
    def self.class_from_string(string)
      string.split('::').inject(Object) { |mod, class_name| mod.const_get(class_name) }
    end
