...
module Discordrb::Events
  ...
  class VoiceChannelEffectEvent < Event
    ...
    # Get the server assoicated with the event.
    # @return [Server] The server that the effect was sent in.
    def server
      @channel.server
    end
    ...
    #   Should always be a member, unless the member was recently removed from the server.
    def member
