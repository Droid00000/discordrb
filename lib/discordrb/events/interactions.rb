...
module Discordrb::Events
  ...
  class InteractionCreateEvent < Event
    ...
    def respond(content: nil, tts: nil, embeds: nil, allowed_mentions: nil, flags: 0, ephemeral: nil, wait: false, components: nil, new_components: false, &block)
      @interaction.respond(
    ...
    def update_message(content: nil, tts: nil, embeds: nil, allowed_mentions: nil, flags: 0, ephemeral: nil, wait: false, components: nil, new_components: false, &block)
    ...
    def edit_response(content: nil, embeds: nil, allowed_mentions: nil, components: nil, new_components: false, &block)
      @interaction.edit_response(
        content: content, embeds: embeds, allowed_mentions: allowed_mentions,
        components: components, new_components: new_components, &block
      )
    end
    ...
    def send_message(content: nil, embeds: nil, tts: false, allowed_mentions: nil, flags: 0, ephemeral: nil, components: nil, new_components: false, &block)
      @interaction.send_message(
        content: content, embeds: embeds, tts: tts, allowed_mentions: allowed_mentions,
        flags: flags, ephemeral: ephemeral, components: components, new_components: new_components,
        &block
      )
    end
