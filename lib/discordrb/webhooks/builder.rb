...
module Discordrb::Webhooks
  ...
  class Builder
    ...
    #   end
    # @param poll [Poll::Builder, Poll, nil] The poll to start the building process with, or nil if one should be created anew.
    ...
    # @return [Poll, nil] the poll attached to this message.
    attr_accessor :poll
