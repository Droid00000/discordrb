...
module Discordrb
  ...
  class Member < DelegateClass(User)
    ...
    def server_banner=(banner)
      ...
      API::Server.update_current_member(@bot.token, @server_id, :undef, nil, banner)
      nil
    end
    ...
    def server_avatar=(avatar)
      ...
      API::Server.update_current_member(@bot.token, @server_id, :undef, nil, :undef, avatar)
      nil
    end
    ...
    def server_bio=(bio)
      ...
      API::Server.update_current_member(@bot.token, @server_id, :undef, nil, :undef, :undef, bio)
      nil
    end
