...
module Discordrb
  ...
  class ApplicationCommand
    ...
    # @param server [Integer, String, nil] the ID of the server to fetch command permissions for.
    ...
    class Permission
      ...
      def initialize(data, bot)
        ...
        @command_id = data['command']['id'].to_i
        @server_id = data['command']['guild_id'].to_i
        @application_id = data['command']['application_id'].to_i
      end
