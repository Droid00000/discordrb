...
module Discordrb
  ...
  class Server
    ...
    # @param permission_overwrites [Array<#to_h, Hash>, nil] The permission overwrite to apply to the channel.
    ...
    def create_channel(
      ...
      default_reaction: nil, default_sort_order: nil, position: nil, default_layout: nil,
      default_thread_rate_limit_per_user: nil, tags: nil, flags: nil, reason: nil
    )
      data = {
        name: name,
        ...
        permission_overwrites: permission_overwrites&.map(&:to_h),
    ...
    def delete_role(role_id)
      ...
      @channels.each_value do |channel|
        channel.remove_permission_overwrite(role_id.resolve_id)
      end
    end
