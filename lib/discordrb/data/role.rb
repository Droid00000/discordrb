...
module Discordrb
  ...
  class Role
    ...
    # @!method in_prompt?
    #   @return [true, false] whether the role can be selected by members in an onboarding prompt.
    ...
    #   @return [true, false] whether any member in the guild can ping the role and its members.
    # @!attribute premium_subscriber?
    #   @return [true, false] whether the role is the auto-generated role assigned to guild boosters.
