...
module Discordrb
  ...
  class InstallParams
    # @return [Array<String>] the default scopes to add an application to a guild with.
    attr_reader :scopes

    # @return [Permissions, nil] the default permissions to add an application to a guild with.
