...
bot.register_application_command(:modal_test, 'Test out a spiffy modal', guild: ENV.fetch('DISCORDRB_GUILD_ID'))
bot.register_application_command(:modal_await_test, 'Test out the await style', guild: ENV.fetch('DISCORDRB_GUILD_ID'))
